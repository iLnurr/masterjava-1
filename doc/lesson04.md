...
- Сделать реализацию в несколько потоков и с учетом того, что пользователей может быть ООчень много.
  - делать всавку группами (chunk) по 2000 в транзакции и batch моде
  - не делать для каждой вставки `nextval`
  - результат импорта - количество успешных и неуспешных вставок, информация, чтобы можно было по исходному xml сделать восстановление данных.
